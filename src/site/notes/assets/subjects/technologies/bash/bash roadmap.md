...
Before  7: learn **[[assets/subjects/technologies/bash/Linux navigation\|Linux navigation]], [[assets/subjects/technologies/bash/permissions\|permissions]], pipes, grep/find, basic scripts, apt, and Python virtual environments**.
